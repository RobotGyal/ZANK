...
from .views import (CodeCreate, CodeDetail, CodeUpdate, CodeDelete)
from django.urls import reverse, reverse_lazy

class CodeCreateTest(TestCase):
    '''an officer can create a new code'''
...
class ZankTests(TestCase):
    '''Tests for the Zank django web app.'''
    def setUp(self):
        '''Create a testing client, will be needed for each test.'''
        self.officer = User.objects.create(username='officer_1',
                                            email='a@email.com',
                                            password='officer')
